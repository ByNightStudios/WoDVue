...
export default class EditPlanManager {
  ...
  getPlanByID(inputs) {
    return PlanService.getPlanByID(inputs);
  }
  ...
  editPlan(inputs) {
    ...
    return PlanService.editPlan(payload);
  }

  deletePlan(inputs) {
    return PlanService.deletePlan(inputs);
  }
}
