...
import styles from './add-offer-page.scss';
...
class AddEventPage extends React.Component {
  ...
  componentDidMount() {
    document.title = 'Emoha Admin | Add a Offer';
  ...
  addCommunityOffer = () => {
    ...
    addOffer(this.state)
      .then((result) => {
        this.openNotification('Success', 'Offer Added Successfully.', 1);
