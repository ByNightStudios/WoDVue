...
import styles from './add-medical-record.scss';
...
class AddMedicalRecord extends Component {
  ...
  handleAddRecord = () => {
    ...
    if (valid) {
      ...
      const dataPayload = {
        ...
        directory_id: this.props.selectedDirectory,
      };

      ElderMedicalRecordManager.addMedicalRecord(dataPayload)
        .then((responseData) => {
        ...
        .catch((errorData) => {
          console.log('UNABLE TO ADD', errorData);
  ...
  render() {
    ...
    return (
      <div className='elder-record-add' style={styles}>
